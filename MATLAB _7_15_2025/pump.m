...
specific_speed = pump_shaft_speed*sqrt(vdot_pump)/(head_pump*g)^0.75;
...
pump_efficiency = 0.94 - 6.983E-4*(vdot_pump/(surface_roughness^2*pump_shaft_speed))^-0.2133 - 0.29*log10(0.83644/specific_speed)^2;
power_pump = vdot_pump * head_pump * density_pump * g / pump_efficiency; % W
