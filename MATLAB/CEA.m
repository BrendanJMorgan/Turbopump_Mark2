...
% x=CEA('reactants','name','HEHN','wt',44.500,'C',2,'H',9,'N',3,'O',4,'h,kcal/mol',-98.000,'rho,g/cc',1.428,'name','HAN','wt',41.830,'H',4,'N',2,'O',4,'h,kcal/mol',-95.300,'rho,g/cc',1.090,'name','AN','wt',02.225,'H',4,'N',2,'O',3,'h,kcal/mol',-87.380,'rho,g/cc',1.725,'name','DIPY
% ','wt',00.445,'C',10,'H',8,'N',2,'h,kcal/mol',44.478,'rho,g/cc',1.326,'name','Water','wt',11.000,'H',2,'O',1,'h,kcal/mol',-68.313,'rho,g/cc',1.000,'problem','rocket','frozen','p,psia',300,'sup,ae/at',10.0000,'output','massf','transport','end','screen');
